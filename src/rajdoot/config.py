...
class Settings(BaseSettings):
    ...
    verification_dashboard_channel_id: int | None = Field(default=None, validation_alias=AliasChoices("VERIFICATION_DASHBOARD_CHANNEL_ID", "CHANNEL_VERIFICATION_DASHBOARD_ID", "CHANNEL_VERIFICATION_ID"))
    ...
    warera_api_country_path: str = "/trpc/country.getCountryById"
